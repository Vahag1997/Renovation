...
export const siteRoutes: SiteRoute[] = [
  {
    ...
    description:
      "Раздел собирает все основные направления работ. Каждая карточка ведет на отдельную пустую страницу услуги.",
    heroImage:
    ...
    children: [
      {
        ...
        description:
          "Будущая страница услуги для квартир. Сейчас здесь только каркас, чтобы проверить путь и визуальную подачу.",
        heroImage:
      ...
      },
      {
        ...
        title: "Ремонт домов",
        description:
          "Пустой маршрут для ремонта частных домов с готовой структурой будущей страницы.",
        heroImage:
      ...
      },
      {
        ...
        description:
          "Маршрут для будущего описания дизайн-проектов, планировок, визуализаций и авторского надзора.",
        heroImage:
      ...
      },
      {
        ...
        description:
          "Пустая страница для офисов, салонов, магазинов и других коммерческих объектов.",
        heroImage:
      ...
      },
      {
        ...
        description:
          "Маршрут для будущей страницы дворов, садов, террас и благоустройства участка.",
        heroImage:
